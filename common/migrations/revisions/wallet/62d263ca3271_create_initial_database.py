...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(),
            nullable=False,
            comment="Código de negociação na B3.",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["asset_b3_code"], ["asset.b3_code"], ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "kind",
            sa.Enum("buy", "sell", name="transactionkind"),
            nullable=False,
        ...
        sa.Column(
            "shares", sa.Integer(), nullable=False, comment="Unidades movimentadas."
        ),
        sa.ForeignKeyConstraint(
            ["asset_b3_code"], ["asset.b3_code"], ondelete="CASCADE"
        ),
